...
docs <- DirSource("C:/Users/damia/OneDrive/Pulpit/R/PSI/Zajcia_8/textfolder")
...
# ODPOWIEDZI ----
# 
# 1. Tak, na podstawie klastrów można wnioskować o treści dokumentów. 
# Na podstawie najczęściej występujących słów w każdym klastrze, 
# oraz na podstawie liczebności klastrów i zróżnicowania dowiadujemy siękluczowych danych na temat dokumentu.
# 
# 2. każdy klaster reprezentuje różne obszary tematyczne,
# w nich grupowane są słowa które posiadają taką samą charakterystykę
# lub są tematycznie najbliżej siebie.może być różna liczba klastrów,
# np 5 i wtedy mamy słowa podzielone na 5 kategorii tematycznych w tych klastrach.
