...
docs <- DirSource("C:/Users/mg471937/Desktop/R/Zajecia_10")

# Utwórz korpus dokumentów tekstowych

# Gdy tekst znajduje się w jednym pliku csv:
data <- read.csv("C:/Users/mg471937/Desktop/R/Zajecia_10/LOT_reviews.csv", stringsAsFactors = FALSE, encoding = "UTF-8")
