...
#' # 1. Dane wejściowe 
docs <- c("Łączna waga wszystkich mrówek na świecie jest większa niż łączna waga wszystkich ludzi.",
          "Gdyby Słońce nagle zniknęło, Ziemia okrążałaby je nadal przez około 8 minut.")
